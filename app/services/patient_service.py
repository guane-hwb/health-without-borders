...
# ---------------------------------------------------------------------------
# H1: Background data hash computation
# ---------------------------------------------------------------------------
...
def create_or_update_patient(
    ...
    Returns:
        ...
        are new (H7), and old_bg_hash to decide whether the
        RDA-Paciente bundle needs regeneration (H1).
    """

    # H3: Lookup scoped by organization — prevents cross-org overwrites.
    ...
    # Compute the new background hash (H1)
    ...
    if existing_patient:
        ...
        db_patient = Patient(
            # H3: Server generates the PK; frontend ID stored separately
